...
export default function ScoreBoard({ playerScore, aiScore, round, totalRounds }: Props) {
  return (
    <div className="flex items-center justify-between w-full max-w-2xl mx-auto px-4 py-3 bg-cream-light rounded-xl border border-wine/20">
      ...
      <div className="text-center">
        <p className="text-xs text-wine uppercase tracking-widest">Round</p>
